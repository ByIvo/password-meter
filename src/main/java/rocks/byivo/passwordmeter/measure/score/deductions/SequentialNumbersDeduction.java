...
import rocks.byivo.passwordmeter.utils.sequence.NumberSequenceVerifier;
import rocks.byivo.passwordmeter.utils.sequence.SequenceVerifier;

@Service
public class SequentialNumbersDeduction implements PasswordScoreDeduction {

    @Override
    public long getTotalBonusFrom(String rawPassword) {
	SequenceVerifier sequenceVerifier = new NumberSequenceVerifier(rawPassword);
